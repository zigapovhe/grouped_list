...
class GroupedListView<T, E> extends StatefulWidget {
  ...
  final int Function(T element1, T element2)? groupComparator;
  ...
  final Widget Function(BuildContext context, T? previousElement, T currentElement, T? nextElement)?
    ...
    if (widget.sort && elements.isNotEmpty) {
      elements.sort((e1, e2) {
        ...
        if (widget.groupComparator != null) {
          compareResult = widget.groupComparator!(e1, e2);
